...
native streaming instead of polling.`,
  ...
  unifi-network-pp-cli tail --interval 10s

  # Tail a specific resource
  unifi-network-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  unifi-network-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
