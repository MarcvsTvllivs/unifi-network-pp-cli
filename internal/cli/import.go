...
but do not stop the import.`,
  ...
  unifi-network-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  unifi-network-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | unifi-network-pp-cli import <resource> --input -`,
